<template>
  <section>
    ...
    <el-table :data="tableData" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="killPrice" label="价格" width="80">
      </el-table-column>
      <el-table-column prop="killCount" label="数量" width="80">
      </el-table-column>
      <el-table-column prop="startTime" label="开秒时间" >
      </el-table-column>
    ...
    <el-col :span="24" class="toolbar">
      ...
      <el-pagination layout="prev, pager, next" @current-change="selectPage" :page-size="10" :total="total" style="float:right;">
      </el-pagination>
    </el-col>
