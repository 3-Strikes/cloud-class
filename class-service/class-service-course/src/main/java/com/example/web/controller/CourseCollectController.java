...
import com.example.service.CourseCollectService;
import com.example.domain.CourseCollect;
import com.example.query.CourseCollectQuery;
...
public class CourseCollectController {
    ...
    @Autowired
    public CourseCollectService courseCollectService;
   ...
   */
    ...
    public JSONResult get(@PathVariable("id")Long id){
        return JSONResult.success(courseCollectService.getById(id));
    }
    ...
    */
    ...
    public JSONResult list(){
        return JSONResult.success(courseCollectService.list());
    }
