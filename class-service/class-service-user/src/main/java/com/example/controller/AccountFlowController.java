...
import com.example.domain.AccountFlow;
import com.example.query.AccountFlowQuery;
import com.example.result.JSONResult;
import com.example.result.PageList;
import com.example.service.AccountFlowService;
...
public class AccountFlowController {
    ...
    @Autowired
    public AccountFlowService accountFlowService;
   ...
   */
    ...
    public JSONResult get(@PathVariable("id")Long id){
        return JSONResult.success(accountFlowService.getById(id));
    }
    ...
    */
    ...
    public JSONResult list(){
        return JSONResult.success(accountFlowService.list());
    }
