...
import com.example.query.MediaFileQuery;
...
public class MediaFileController {
    ...
    public JSONResult mergechunks(
        ...
        return mediaFileService.mergechunks(fileMd5,fileName,fileSize,mimetype,fileExt,chapterId,courseId,name,courseName,chapterName);
    }
   ...
   */
    ...
    public JSONResult get(@PathVariable("id")Long id){
        return JSONResult.success(mediaFileService.getById(id));
    }
    ...
    */
    ...
    public JSONResult list(){
        return JSONResult.success(mediaFileService.list());
    }
