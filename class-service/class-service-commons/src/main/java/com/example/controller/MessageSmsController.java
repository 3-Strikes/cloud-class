...
import com.example.query.MessageSmsQuery;
...
public class MessageSmsController {
    ...
    @Autowired
    public MessageSmsService messageSmsService;
   ...
   */
    ...
    public JSONResult get(@PathVariable("id")Long id){
        return JSONResult.success(messageSmsService.getById(id));
    }
    ...
    */
    ...
    public JSONResult list(){
        return JSONResult.success(messageSmsService.list());
    }
