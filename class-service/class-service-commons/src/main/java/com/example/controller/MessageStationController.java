...
import com.example.query.MessageStationQuery;
...
public class MessageStationController {
    ...
    @Autowired
    public MessageStationService messageStationService;
   ...
   */
    ...
    public JSONResult get(@PathVariable("id")Long id){
        return JSONResult.success(messageStationService.getById(id));
    }
    ...
    */
    ...
    public JSONResult list(){
        return JSONResult.success(messageStationService.list());
    }
